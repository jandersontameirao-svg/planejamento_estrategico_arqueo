...
export default function DashboardAnalisesParticipacoes() {
  const PARTICIPACOES_ID = -1;
  
  // Queries para buscar dados das análises do Grupo
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6">
      <PageHeaderWithBack
        title="Dashboard de Análises - Grupo Arqueo Participações"
        description="Visão geral das análises estratégicas do Grupo Arqueo Participações"
        backUrl="/planejamento-participacoes"
      />
