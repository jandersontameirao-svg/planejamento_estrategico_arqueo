...
export default function DashboardAnalisesGrupo() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6">
      <PageHeaderWithBack
        title="Dashboard de Análises - Grupo Arqueo"
        description="Visão geral das análises estratégicas do Grupo"
        backUrl="/planejamento-grupo"
      />
